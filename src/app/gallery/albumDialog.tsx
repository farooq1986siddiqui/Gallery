  ...
  return (
    <div>
      ...
      <DialogTrigger asChild>
        <Button variant="ghost" className="p-0 m-0"><AiFillFolderAdd className="w-6 h-6 cursor-pointer text-white hover:text-red-500 duration-300"/></Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Add to Album</DialogTitle>
          <DialogDescription>
            Enter the Album Name. Click Add when you're done.
          </DialogDescription>
        </DialogHeader>
